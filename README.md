...
2. Install prerequisites:
  ...
  ```
  ```sh
  sudo pacman -S texlive-latex texlive-latexextra texlive-langeuropean texlive-fontsrecommended texlive-plaingeneric libpaper; echo "a4" | sudo tee /etc/papersize
  ```
3. Build the sangbog
